    ...
    <>
      ...
      <main className={styles.servicesMain}>
        <div className={styles.section1}>
          <section className={styles.servicesHeader}>
            ...
            <p className={styles.servicesSubtitle}>
              Discover the perfect tan tailored to your skin type and
              preferences.
            </p>
          </section>
          ...
          <section className={styles.feeSection}>
            ...
            <p>
              ...
              the Wilmington area by 10-15 miles, there will be a $10 travel
              fee. If you are outside of the Wilmington area by 16-20 miles,
              there will be a $20 travel fee. If you are outside of the
              Wilmington area by 20+ miles, please contact me for more
              information. My contact information can be found at the bottom of
              this page. Thank you!
            </p>
          </section>
        </div>
        ...
        <div className={styles.section2}>
          ...
          <section className={styles.servicesHeader}>
            <h1 className={styles.servicesTitle}>Addons</h1>
            <p className={styles.servicesSubtitle}>
              Enhance your experience with our hand-picked products
            </p>
          </section>

          <section className={styles.productSection}>
            <h4 className={styles.productCategory}>Scent Drops</h4>
            <ServiceCard
              title="Coconut Scent Drops"
              description="A tropical escape"
              price="$7"
            />
            <ServiceCard
            ...
            <ServiceCard
              ...
              description="Zesty and invigorating"
              price="$7"
            />
          </section>
          ...
          <section className={styles.productSection}>
            ...
            <ServiceCard
              ...
              description="Extend your tan with this moisturizing lotion"
              price="$25"
            />
          </section>
        </div>
